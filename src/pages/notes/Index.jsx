      ...
      <section className="my-[55px] bg-[#202427] md:rounded-[12px] max-w-7xl mx-auto px-[16px] md:px-[105px] py-[60px]">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-3">
            <h1 className="text-[24px] font-bold text-[#F9FAFB] mb-3">Notes</h1>
                    ...
                    {notes.map((note) => (
                      <tr key={note.id}>
                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                          <p className="font-medium text-white">{note.note}</p>
                        </td>
                        <td className="whitespace-nowrap py-4 pr-4 pl-3 text-sm sm:pr-6">
                          <p className="font-medium text-white">{note.user.first_name}</p>
                        </td>
                        <td className="whitespace-nowrap py-4 pr-4 pl-3 text-sm sm:pr-6">
                          <p className="font-medium text-white">{note.post.slug}</p>
                        </td>
