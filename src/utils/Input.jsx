    ...
    return (
        <fieldset htmlFor={name} className={rootClasses}>
            <div className="min-h-[56px] relative flex bg-[#41474D] rounded-[4px] px-[14px] py-[10px] ">
                ...
                <label
                    htmlFor={name}
                    className={`cursor-text text-[#FFFFFF] transition-all absolute top-1/2 -translate-y-1/2 peer-focus:leading-[14px] peer-focus:text-[12px] peer-focus:top-[10px] peer-focus:translate-y-0 peer-focus:opacity-50 ${
                    labelClasses
                    } ${
                    props.defaultValue !== ""
                    ? "leading-[14px] text-[12px] top-[10px] translate-y-0 opacity-50"
